...
class LivenessCheckModuleTest{
    private lateinit var moduleBuilder: LivenessCheckModule.Builder

    @Before
    fun initializeBuilderWithConstructorOnly(){

        moduleBuilder = LivenessCheckModule.Builder("16A521")
    }
    @Test
    ...
    fun builderWithMetaData_shouldCreateInstanceWithCorrectMetaData(){
        ...
        val metadata = mapOf("Tola" to 11, "Kemi" to 0)
        val workflowBuilderModule = moduleBuilder.metaData(metadata)
        assertTrue(workflowBuilderModule.metaData.containsKey("Tola"))
    }
}